...
BOT_USERNAME = os.environ.get("BOT_USERNAME", "Mdiso_To_File_Bot")
...
def echo(client, message):
       app.send_message(message.reply.photo,(photo=" https://telegra.ph/file/3d10c6b1d67fdd95f701e.jpg", caption=f'Hi 👋\n\nI Am {BOT_NAME}\n\nUse Me To Download Mdisk Link To 📁File\n\nSend Me The Mdisk Link Like ➡️\n /mdisk https://mdisk.me/link'),
